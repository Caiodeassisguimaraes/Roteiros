...
public class Principal {
	...
	public static void main(String[] args) {
		...
		/*
		 * Aluno aluno01 = new Aluno(111, "Jose", "Sistema de Informação", 2019); Aluno
		 * aluno02 = new Aluno(222, "Maria", "Engenharia Civil", 2020); Aluno aluno03 =
		 * new Aluno(333, "Carlos", "Quimica", 2021);
		 * 
		 * // Armazenando os objetos no vetor de alunos listaAlunos[0] = aluno01;
		 * listaAlunos[1] = aluno02; listaAlunos[2] = aluno03;
		 */
